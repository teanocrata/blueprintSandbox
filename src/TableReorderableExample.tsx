...
export class TableReorderableExample extends React.PureComponent<
  IExampleProps,
  ITableReorderableExampleState
> {
  public state: ITableReorderableExampleState = {
    columns: [
      ...
      <Column
        key="1"
        name="Letter"
        cellRenderer={this.getCellRenderer("letter")}
      />,
      <Column
        key="2"
        name="Fruit"
        cellRenderer={this.getCellRenderer("fruit")}
      />,
      <Column
        key="3"
        name="Animal"
        cellRenderer={this.getCellRenderer("animal")}
      />,
      <Column
        key="4"
        name="Country"
        cellRenderer={this.getCellRenderer("country")}
      />,
